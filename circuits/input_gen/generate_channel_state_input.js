...
// section 2 for why).
//
// Usage: node input_gen/generate_channel_state_input.js [contractAddress] [chainId] > build/input.json
...
//                      use scripts/prove_and_export.js instead, which is what
//                      the Foundry tests use via FFI).
//   chainId          - defaults to 31337 (Anvil/Foundry default)

const { buildInput } = require("./build_channel_state_input");
