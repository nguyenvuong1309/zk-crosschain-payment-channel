...
interface IConsensusVerifier {
    function verifyProof(uint256[2] calldata _pA, uint256[2][2] calldata _pB, uint256[2] calldata _pC, uint256[13] calldata _pubSignals)
        external
        view
        returns (bool);
}
...
contract LightClientVerifier {
    ...
    uint256 internal constant VALIDATOR_X_0 = 21246438685519020325909427042851760438517789672650587758045368771856606251977;
    uint256 internal constant VALIDATOR_X_1 = 17989828173199788198515330908044542986707065169673686905037405048349118572501;
    uint256 internal constant VALIDATOR_X_2 = 6792796706312533171496143877377482156730541513184164084941301707682079080689;
    uint256 internal constant VALIDATOR_X_3 = 7497374464861137184037981613537692868861134298803862847037479277114870475046;
    uint256 internal constant VALIDATOR_X_4 = 12365000354977448349146557652237367341860215530550891410559730228320666707339;

    uint256 internal constant VALIDATOR_Y_0 = 21757912420971379721172534150676790146484352047023251811005756971811108432764;
    uint256 internal constant VALIDATOR_Y_1 = 5347085815635334027628529991145958795773335864739033871168351822057471290801;
    uint256 internal constant VALIDATOR_Y_2 = 2674306955426078087016246293517136394933518656170578475876581817156998622208;
    uint256 internal constant VALIDATOR_Y_3 = 7535159088071458283769393973861762513693647629357217726468953113823810968134;
    uint256 internal constant VALIDATOR_Y_4 = 780711816540583673934192943661512197357117218017765651354867965984941584560;
    ...
    function updateState(uint256[2] calldata a, uint256[2][2] calldata b, uint256[2] calldata c, uint256[13] calldata pubSignals)
        external
    {
